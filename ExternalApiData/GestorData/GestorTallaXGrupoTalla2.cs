...
{
    public class GestorTallaXGrupoTalla2
    {
        
        private static string UrlString = $"{Enviroment.KREAWebServiceURLApi}productos/imhn/tallas";
        ...
        static GestorTallaXGrupoTalla2()
        {
