...
namespace AventasApi.GestorData
{
    ...
    {
         private static string UrlString = @"http://190.109.223.244:8083/api/facturas/IMHN/gmonrroy/gmonrroy/0/{0}";
                                    ...
                                    using (AVentasEntities context = new AVentasEntities())
                                    {
                                        try
                                        {
                                            ...
                                            SubFacturasxCliente acuerdo = new SubFacturasxCliente
                                            {
                                                ...
                                                FechaVencimiento = DateTime.ParseExact(txg.DUE_DATE, "dd/MM/yyyy", CultureInfo.InvariantCulture),
                                                FechaMaxDescuento = DateTime.ParseExact(txg.LIMIT_DATE, "dd/MM/yyyy", CultureInfo.InvariantCulture),
                                                FechaVencimientoDescuento = DateTime.ParseExact(txg.DISC_DATE, "dd/MM/yyyy", CultureInfo.InvariantCulture),
