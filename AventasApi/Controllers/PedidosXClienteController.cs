        ...
        public async Task<IHttpActionResult> GetFlotantes(DateTime FechaInicio, DateTime FechaFin, int estado)
        {
            try
            {
                using (AVentasEntities ctx = new AVentasEntities())
                {
                    ...
                    List<PedidosXClienteViewModel> pedidosFlotanteEnviar = new List<PedidosXClienteViewModel>();
                    foreach (var asesor in asesoresHabilitados)
                    {
                        ...
                        pedidosFlotanteEnviar.AddRange(pedidosFlotantes);
                    }

                    return Ok(pedidosFlotanteEnviar);
                }
            }
            catch (Exception e)
            {
